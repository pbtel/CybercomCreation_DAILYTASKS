    ...
    <div class="products-layout">
        ...
        <div class="filter-panel">
            <div class="filter-top">
                ...
                <a href="<?= BASE_URL ?>/products" class="filter-reset-link">Reset All</a>
            </div>
        ...
        <div class="products-main-content">
            <div class="products-toolbar">
                <div class="toolbar-info">
                    Showing <strong><?php echo count($displayProducts); ?></strong> products
                </div>
            ...
            <div class="products-container <?php echo $viewMode === 'list' ? 'list-layout' : ''; ?>">
                <?php if (empty($displayProducts)): ?>
                    <div class="no-products">
                        ...
                        <a href="<?= BASE_URL ?>/products" class="btn-clear-filters">Clear Filters</a>
                    </div>
                <?php else: ?>
                            ...
                            <div class="product-details">
                                ...
                                <div class="product-pricing">
                                    ...
                                    <?php if ($product['original_price'] > $product['price']): ?>
                                        <span
                                            class="product-old-price"><?php echo formatPrice($product['original_price']); ?></span>
                                    <?php endif; ?>
                                </div>
        ...
        </div> <!-- Close products-main-content -->
    </div> <!-- Close products-layout -->
</div>
