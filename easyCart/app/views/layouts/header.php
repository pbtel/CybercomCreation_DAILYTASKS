    ...
    <header>
        <div class="header-wrapper">
            ...
            <nav class="header-nav">
                ...
                <a href="<?php echo BASE_URL; ?>/cart">Cart<span class="cart-badge <?php echo Session::getCartCount() > 0 ? '' : 'display-none'; ?>" id="cartBadge"><?php echo Session::getCartCount(); ?></span></a>
                ...
                <?php if ($user['logged_in']): ?>
                    <a href="<?php echo BASE_URL; ?>/logout">Logout (<?php echo htmlspecialchars($user['name']); ?>)</a>
                <?php else: ?>
