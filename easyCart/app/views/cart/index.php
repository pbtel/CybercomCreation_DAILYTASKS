                    ...
                    <div data-cart-item data-cart-key="<?php echo $key; ?>" class="cart-item-card">
                        ...
                        <div>
                            <h3 class="fs-1-125 font-600 mb-0-5">
                                <a href="<?php echo BASE_URL; ?>/product/<?php echo $item['product']['id']; ?>" class="color-inherit td-n">
                            ...
                            <div class="mt-0-75">
                                <?php if ($item['discount_percent'] > 0): ?>
                                    ...
                                    <p class="price-savings">
                                        Save ₹<?php echo number_format($item['first_unit_savings']); ?> (<?php echo $item['discount_percent']; ?>% off)
                                    </p>
                                <?php else: ?>
                ...
                <div class="sticky-summary">
                    <div class="card">
                        ...
                        <div class="summary-row fs-1-25 font-700 mb-2">
                            ...
                            <span class="color-primary" data-estimated-total>₹<?php echo number_format($subtotalAfterCoupon); ?>+</span>
                        </div>
